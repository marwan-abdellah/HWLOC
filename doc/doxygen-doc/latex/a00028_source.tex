...
00088 
00089   sprintf(path, \textcolor{stringliteral}{"/sys/bus/pci/devices/%04x:%02x:%02x.0/local\_cpus"}, domainid, bus
      id, deviceid);
00090   sysfile = fopen(path, \textcolor{stringliteral}{"r"});
00091   \textcolor{keywordflow}{if} (!sysfile)
00092     \textcolor{keywordflow}{return} -1;
00093 
00094   \hyperlink{a00067_gaeacad897c30dbea284948374ad4b010c}{hwloc_linux_parse_cpumap_file}(sysfile, \textcolor{keyword}{set});
00095   \textcolor{keywordflow}{if} (\hyperlink{a00065_gaa94fed35d2a598bc4a8657b6955b7bf5}{hwloc_bitmap_iszero}(\textcolor{keyword}{set}))
...
00097 
00098   fclose(sysfile);
00099 \textcolor{preprocessor}{#else}
00100 \textcolor{preprocessor}{}  \textcolor{comment}{/* Non-Linux systems simply get a full cpuset */}
00101   \hyperlink{a00065_gab14743355fa03b36cef521cbcd2fbf64}{hwloc_bitmap_copy}(\textcolor{keyword}{set}, \hyperlink{a00060_ga418ebb39eaf1eac8f9cf4047cf59a534}{hwloc_topology_get_complete_cpuset}(topology));
00102 \textcolor{preprocessor}{#endif}
00103 \textcolor{preprocessor}{}  \textcolor{keywordflow}{return} 0;
00104 \}
00105 
00112 \textcolor{keyword}{static} \_\_hwloc\_inline \hyperlink{a00016}{hwloc_obj_t}
\hypertarget{a00028_source_l00113}{}\hyperlink{a00071_ga04d1f8bd566a7f0b30d5e498f9228042}{00113} \hyperlink{a00071_ga04d1f8bd566a7f0b30d5e498f9228042}{hwloc_cuda_get_device_pcidev}(\hyperlink{a00039_ga9d1e76ee15a7dee158b786c30b6a6e38}{hwloc_topology_t} topology, CUdevice cudevice)
00114 \{
00115   \textcolor{keywordtype}{int} domain, bus, dev;
00116 
00117   \textcolor{keywordflow}{if} (\hyperlink{a00071_gae45c92fbc7ac538cf69fdfcc73994ed9}{hwloc_cuda_get_device_pci_ids}(topology, cudevice, &domain, &bus, &dev))
00118     \textcolor{keywordflow}{return} NULL;
00119 
00120   \textcolor{keywordflow}{return} \hyperlink{a00064_ga546e1d690c63fb24177f3013ed78ceb1}{hwloc_get_pcidev_by_busid}(topology, domain, bus, dev, 0);
00121 \}
00122 
00126 \textcolor{preprocessor}{#ifdef \_\_cplusplus}
00127 \textcolor{preprocessor}{}\} \textcolor{comment}{/* extern "C" */}
00128 \textcolor{preprocessor}{#endif}
00129 \textcolor{preprocessor}{}
00130 
00131 \textcolor{preprocessor}{#endif }\textcolor{comment}{/* HWLOC\_CUDA\_H */}
\end{DoxyCode}
